...
### RELEASE NOTES:
- **v1.1.5** (Jul 07, 2025): PV configuration v1 support included in all requests and datasets (not yet implemented in backend). Added new optional properties to Site in solargis_common_types
