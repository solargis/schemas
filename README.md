...
### RELEASE NOTES:
- **v1.1.7** (Jul 07, 2026): Added new properties for dataset (projectCode), column (qualityControl, instrumentCoordinates); License (licenseCode, attribution, citation, dataSharing), Instrument (ventilationHeating, shadingRing, shadingBall), Flag (color, priority), Environment (landscapeRepresentativeness, surroundings, photodocumentation), Report (satelliteRegion, comparisonModelType, reportPublishing, validationSitePublishing)
