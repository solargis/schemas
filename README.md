...
### RELEASE NOTES:
- **v1.1.7** (Jul 09, 2026): Added new properties for dataset (projectCode), column (qualityControl, instrumentCoordinates); License (licenseCode, attribution, citation, dataSharing), Instrument (ventilationHeating, shadingTechnology), Environment (landscapeRepresentativeness, surroundings, photodocumentation), Report (satelliteRegion, comparisonModelType, reportPublishing, validationSitePublishing)
